...
-------------
Один актор (если он remote) принимает по сети 1К - 1.5К сообщений в секунду максимум. Я запускал 10 jvm машин, некоторые из них были в VirtualBox под линуксом, некоторые под видной локально. В такой конфигурации с таким принципом работы, можно получать 10К сообщений в секунду и больше на одной ноде.
